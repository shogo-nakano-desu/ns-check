# Contributing to nsprobe

Thanks for wanting to help! nsprobe is a small, focused tool and contributions of all sizes are welcome — from typo fixes to new registry checkers.
...
5. **Keep the interface small.** nsprobe is intentionally simple. If a feature needs a flag, think twice.
...
- Homebrew formula for installing nsprobe itself
