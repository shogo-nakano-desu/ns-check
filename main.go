...
import (
	...
	"github.com/shogonakano/namo/output"
	"github.com/shogonakano/namo/runner"
)
...
func run(args []string) int {
	fs := flag.NewFlagSet("namo", flag.ContinueOnError)
	...
	fs.Usage = func() {
		fmt.Fprintf(os.Stderr, "namo - NAMing OK? Check namespace availability.\n\n")
		...
		fmt.Fprintf(os.Stderr, "  namo --skip domain myproject\n")
	}
